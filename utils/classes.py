...
CLASSES = {'pascal': ['background', 'aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 
           ...
           'ade20k': ['wall', 'building', 'sky', 'floor', 'tree', 'ceiling', 'road', 'bed ',
            ...
            'flare22': ['Liver', 'Right kidney', 'Spleen', 'Pancreas', 'Aorta', 'IVC', 
                      'RAG', 'LAG', 'Gallbladder', 'Esophagus', 'Stomach', 'Duodenum', 'Left kidney'],

            'amos': ['Spleen', 'Right kidney', 'Left kidney', 'Gallbladder', 'Esophagus','Liver', 'Stomach', 'Aorta',
                         'IVC', 'Pancreas',  'RAG', 'LAG', 'Duodenum', 'Bladder', 'Prostate/Uterus'],
            'flare22_ssl': ['background', 'Liver', 'Right kidney', 'Spleen', 'Pancreas', 'Aorta', 'IVC', 
                      'RAG', 'LAG', 'Gallbladder', 'Esophagus', 'Stomach', 'Duodenum', 'Left kidney'],

            'amos_ssl': ['background', 'Spleen', 'Right kidney', 'Left kidney', 'Gallbladder', 'Esophagus','Liver', 'Stomach', 'Aorta',
                         'IVC', 'Pancreas',  'RAG', 'LAG', 'Duodenum', 'Bladder', 'Prostate/Uterus'],
